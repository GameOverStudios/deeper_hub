defmodule DeeperHub.Schema.BxPostsSound do
  @moduledoc """
  Schema para representação de bx_posts_sounds no sistema
  ...
  @typedoc """
  Tipo que representa um bx_posts_sound no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_posts_sound.

  ## Parâmetros 
    - `bx_posts_sound`: Struct do bx_posts_sound (pode ser %BxPostsSound{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_posts_sound \ %__MODULE__{}, attrs) do
    bx_posts_sound
  ...
  @doc """
  Changeset para atualização de um bx_posts_sound existente.

  ## Parâmetros 
    - `bx_posts_sound`: Struct do bx_posts_sound (%BxPostsSound{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_posts_sound \ %__MODULE__{}, attrs) do
    bx_posts_sound
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
