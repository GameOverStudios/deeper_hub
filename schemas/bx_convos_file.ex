defmodule DeeperHub.Schema.BxConvosFile do
  @moduledoc """
  Schema para representação de bx_convos_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_convos_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_convos_file.

  ## Parâmetros 
    - `bx_convos_file`: Struct do bx_convos_file (pode ser %BxConvosFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_convos_file \ %__MODULE__{}, attrs) do
    bx_convos_file
  ...
  @doc """
  Changeset para atualização de um bx_convos_file existente.

  ## Parâmetros 
    - `bx_convos_file`: Struct do bx_convos_file (%BxConvosFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_convos_file \ %__MODULE__{}, attrs) do
    bx_convos_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
