defmodule DeeperHub.Schema.BxJobsCmt do
  @moduledoc """
  Schema para representação de bx_jobs_cmts no sistema
  ...
  @typedoc """
  Tipo que representa um bx_jobs_cmt no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_jobs_cmt.

  ## Parâmetros 
    - `bx_jobs_cmt`: Struct do bx_jobs_cmt (pode ser %BxJobsCmt{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_jobs_cmt \ %__MODULE__{}, attrs) do
    bx_jobs_cmt
  ...
  @doc """
  Changeset para atualização de um bx_jobs_cmt existente.

  ## Parâmetros 
    - `bx_jobs_cmt`: Struct do bx_jobs_cmt (%BxJobsCmt{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_jobs_cmt \ %__MODULE__{}, attrs) do
    bx_jobs_cmt
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
