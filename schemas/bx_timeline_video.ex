defmodule DeeperHub.Schema.BxTimelineVideo do
  @moduledoc """
  Schema para representação de bx_timeline_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_timeline_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_timeline_video.

  ## Parâmetros 
    - `bx_timeline_video`: Struct do bx_timeline_video (pode ser %BxTimelineVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_timeline_video \ %__MODULE__{}, attrs) do
    bx_timeline_video
  ...
  @doc """
  Changeset para atualização de um bx_timeline_video existente.

  ## Parâmetros 
    - `bx_timeline_video`: Struct do bx_timeline_video (%BxTimelineVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_timeline_video \ %__MODULE__{}, attrs) do
    bx_timeline_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
