defmodule DeeperHub.Schema.BxGroupsPic do
  @moduledoc """
  Schema para representação de bx_groups_pics no sistema
  ...
  @typedoc """
  Tipo que representa um bx_groups_pic no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_groups_pic.

  ## Parâmetros 
    - `bx_groups_pic`: Struct do bx_groups_pic (pode ser %BxGroupsPic{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_groups_pic \ %__MODULE__{}, attrs) do
    bx_groups_pic
  ...
  @doc """
  Changeset para atualização de um bx_groups_pic existente.

  ## Parâmetros 
    - `bx_groups_pic`: Struct do bx_groups_pic (%BxGroupsPic{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_groups_pic \ %__MODULE__{}, attrs) do
    bx_groups_pic
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
