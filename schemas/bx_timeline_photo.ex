defmodule DeeperHub.Schema.BxTimelinePhoto do
  @moduledoc """
  Schema para representação de bx_timeline_photos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_timeline_photo no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_timeline_photo.

  ## Parâmetros 
    - `bx_timeline_photo`: Struct do bx_timeline_photo (pode ser %BxTimelinePhoto{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_timeline_photo \ %__MODULE__{}, attrs) do
    bx_timeline_photo
  ...
  @doc """
  Changeset para atualização de um bx_timeline_photo existente.

  ## Parâmetros 
    - `bx_timeline_photo`: Struct do bx_timeline_photo (%BxTimelinePhoto{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_timeline_photo \ %__MODULE__{}, attrs) do
    bx_timeline_photo
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
