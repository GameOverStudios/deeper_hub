defmodule DeeperHub.Schema.BxPollsFile do
  @moduledoc """
  Schema para representação de bx_polls_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_polls_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_polls_file.

  ## Parâmetros 
    - `bx_polls_file`: Struct do bx_polls_file (pode ser %BxPollsFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_polls_file \ %__MODULE__{}, attrs) do
    bx_polls_file
  ...
  @doc """
  Changeset para atualização de um bx_polls_file existente.

  ## Parâmetros 
    - `bx_polls_file`: Struct do bx_polls_file (%BxPollsFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_polls_file \ %__MODULE__{}, attrs) do
    bx_polls_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
