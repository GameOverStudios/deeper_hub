defmodule DeeperHub.Schema.BxSpacesCmt do
  @moduledoc """
  Schema para representação de bx_spaces_cmts no sistema
  ...
  @typedoc """
  Tipo que representa um bx_spaces_cmt no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_spaces_cmt.

  ## Parâmetros 
    - `bx_spaces_cmt`: Struct do bx_spaces_cmt (pode ser %BxSpacesCmt{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_spaces_cmt \ %__MODULE__{}, attrs) do
    bx_spaces_cmt
  ...
  @doc """
  Changeset para atualização de um bx_spaces_cmt existente.

  ## Parâmetros 
    - `bx_spaces_cmt`: Struct do bx_spaces_cmt (%BxSpacesCmt{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_spaces_cmt \ %__MODULE__{}, attrs) do
    bx_spaces_cmt
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
