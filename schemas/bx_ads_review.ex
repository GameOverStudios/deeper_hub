defmodule DeeperHub.Schema.BxAdsReview do
  @moduledoc """
  Schema para representação de bx_ads_reviews no sistema
  ...
  @typedoc """
  Tipo que representa um bx_ads_review no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_ads_review.

  ## Parâmetros 
    - `bx_ads_review`: Struct do bx_ads_review (pode ser %BxAdsReview{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_ads_review \ %__MODULE__{}, attrs) do
    bx_ads_review
  ...
  @doc """
  Changeset para atualização de um bx_ads_review existente.

  ## Parâmetros 
    - `bx_ads_review`: Struct do bx_ads_review (%BxAdsReview{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_ads_review \ %__MODULE__{}, attrs) do
    bx_ads_review
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
