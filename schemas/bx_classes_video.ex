defmodule DeeperHub.Schema.BxClassesVideo do
  @moduledoc """
  Schema para representação de bx_classes_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_classes_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_classes_video.

  ## Parâmetros 
    - `bx_classes_video`: Struct do bx_classes_video (pode ser %BxClassesVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_classes_video \ %__MODULE__{}, attrs) do
    bx_classes_video
  ...
  @doc """
  Changeset para atualização de um bx_classes_video existente.

  ## Parâmetros 
    - `bx_classes_video`: Struct do bx_classes_video (%BxClassesVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_classes_video \ %__MODULE__{}, attrs) do
    bx_classes_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
