defmodule DeeperHub.Schema.BxTasksPhoto do
  @moduledoc """
  Schema para representação de bx_tasks_photos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_tasks_photo no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_tasks_photo.

  ## Parâmetros 
    - `bx_tasks_photo`: Struct do bx_tasks_photo (pode ser %BxTasksPhoto{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_tasks_photo \ %__MODULE__{}, attrs) do
    bx_tasks_photo
  ...
  @doc """
  Changeset para atualização de um bx_tasks_photo existente.

  ## Parâmetros 
    - `bx_tasks_photo`: Struct do bx_tasks_photo (%BxTasksPhoto{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_tasks_photo \ %__MODULE__{}, attrs) do
    bx_tasks_photo
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
