defmodule DeeperHub.Schema.BxTasksCover do
  @moduledoc """
  Schema para representação de bx_tasks_covers no sistema
  ...
  @typedoc """
  Tipo que representa um bx_tasks_cover no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_tasks_cover.

  ## Parâmetros 
    - `bx_tasks_cover`: Struct do bx_tasks_cover (pode ser %BxTasksCover{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_tasks_cover \ %__MODULE__{}, attrs) do
    bx_tasks_cover
  ...
  @doc """
  Changeset para atualização de um bx_tasks_cover existente.

  ## Parâmetros 
    - `bx_tasks_cover`: Struct do bx_tasks_cover (%BxTasksCover{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_tasks_cover \ %__MODULE__{}, attrs) do
    bx_tasks_cover
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
