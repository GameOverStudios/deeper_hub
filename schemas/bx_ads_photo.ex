defmodule DeeperHub.Schema.BxAdsPhoto do
  @moduledoc """
  Schema para representação de bx_ads_photos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_ads_photo no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_ads_photo.

  ## Parâmetros 
    - `bx_ads_photo`: Struct do bx_ads_photo (pode ser %BxAdsPhoto{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_ads_photo \ %__MODULE__{}, attrs) do
    bx_ads_photo
  ...
  @doc """
  Changeset para atualização de um bx_ads_photo existente.

  ## Parâmetros 
    - `bx_ads_photo`: Struct do bx_ads_photo (%BxAdsPhoto{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_ads_photo \ %__MODULE__{}, attrs) do
    bx_ads_photo
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
