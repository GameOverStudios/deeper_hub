defmodule DeeperHub.Schema.BxVideosCmtsNote do
  @moduledoc """
  Schema para representação de bx_videos_cmts_notes no sistema
  ...
  schema "bx_videos_cmts_notes" do
  ...
  @typedoc """
  Tipo que representa um bx_videos_cmts_note no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_videos_cmts_note.

  ## Parâmetros 
    - `bx_videos_cmts_note`: Struct do bx_videos_cmts_note (pode ser %BxVideosCmtsNote{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_videos_cmts_note \ %__MODULE__{}, attrs) do
    bx_videos_cmts_note
  ...
  @doc """
  Changeset para atualização de um bx_videos_cmts_note existente.

  ## Parâmetros 
    - `bx_videos_cmts_note`: Struct do bx_videos_cmts_note (%BxVideosCmtsNote{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_videos_cmts_note \ %__MODULE__{}, attrs) do
    bx_videos_cmts_note
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned])
  end
end
