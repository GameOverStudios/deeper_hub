defmodule DeeperHub.Schema.BxAlbumsCmtsMedia do
  @moduledoc """
  Schema para representação de bx_albums_cmts_medias no sistema
  ...
  schema "bx_albums_cmts_media" do
  ...
  @typedoc """
  Tipo que representa um bx_albums_cmts_media no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_albums_cmts_media.

  ## Parâmetros 
    - `bx_albums_cmts_media`: Struct do bx_albums_cmts_media (pode ser %BxAlbumsCmtsMedia{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_albums_cmts_media \ %__MODULE__{}, attrs) do
    bx_albums_cmts_media
  ...
  @doc """
  Changeset para atualização de um bx_albums_cmts_media existente.

  ## Parâmetros 
    - `bx_albums_cmts_media`: Struct do bx_albums_cmts_media (%BxAlbumsCmtsMedia{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_albums_cmts_media \ %__MODULE__{}, attrs) do
    bx_albums_cmts_media
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
