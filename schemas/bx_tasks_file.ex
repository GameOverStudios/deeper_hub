defmodule DeeperHub.Schema.BxTasksFile do
  @moduledoc """
  Schema para representação de bx_tasks_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_tasks_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_tasks_file.

  ## Parâmetros 
    - `bx_tasks_file`: Struct do bx_tasks_file (pode ser %BxTasksFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_tasks_file \ %__MODULE__{}, attrs) do
    bx_tasks_file
  ...
  @doc """
  Changeset para atualização de um bx_tasks_file existente.

  ## Parâmetros 
    - `bx_tasks_file`: Struct do bx_tasks_file (%BxTasksFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_tasks_file \ %__MODULE__{}, attrs) do
    bx_tasks_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
