defmodule DeeperHub.Schema.BxForumVideo do
  @moduledoc """
  Schema para representação de bx_forum_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_forum_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_forum_video.

  ## Parâmetros 
    - `bx_forum_video`: Struct do bx_forum_video (pode ser %BxForumVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_forum_video \ %__MODULE__{}, attrs) do
    bx_forum_video
  ...
  @doc """
  Changeset para atualização de um bx_forum_video existente.

  ## Parâmetros 
    - `bx_forum_video`: Struct do bx_forum_video (%BxForumVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_forum_video \ %__MODULE__{}, attrs) do
    bx_forum_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
