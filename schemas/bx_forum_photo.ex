defmodule DeeperHub.Schema.BxForumPhoto do
  @moduledoc """
  Schema para representação de bx_forum_photos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_forum_photo no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_forum_photo.

  ## Parâmetros 
    - `bx_forum_photo`: Struct do bx_forum_photo (pode ser %BxForumPhoto{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_forum_photo \ %__MODULE__{}, attrs) do
    bx_forum_photo
  ...
  @doc """
  Changeset para atualização de um bx_forum_photo existente.

  ## Parâmetros 
    - `bx_forum_photo`: Struct do bx_forum_photo (%BxForumPhoto{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_forum_photo \ %__MODULE__{}, attrs) do
    bx_forum_photo
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
