defmodule DeeperHub.Schema.BxTasksTask do
  @moduledoc """
  Schema para representação de bx_tasks_tasks no sistema
  ...
  schema "bx_tasks_tasks" do
    ...
    field :due_date, :integer  # int(11)
    field :tasks_list, :integer  # int(11)
    field :completed, :integer, default: 0  # tinyint(4)
    field :expired, :integer, default: 0  # tinyint(4)
  ...
  @typedoc """
  Tipo que representa um bx_tasks_task no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    author: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_tasks_task.

  ## Parâmetros 
    - `bx_tasks_task`: Struct do bx_tasks_task (pode ser %BxTasksTask{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_tasks_task \ %__MODULE__{}, attrs) do
    bx_tasks_task
    |> cast(attrs, [:author, :added, :changed, :published, :thumb, :title, :cat, :multicat, :text, :labels, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :favorites, :comments, :reports, :featured, :due_date, :tasks_list, :completed, :expired, :cf, :allow_view_to, :allow_comments, :status, :status_admin])
    |> validate_required([:author, :added, :changed, :published, :thumb, :title, :cat, :multicat, :text, :labels, :due_date, :tasks_list])
  end

  @doc """
  Changeset para atualização de um bx_tasks_task existente.

  ## Parâmetros 
    - `bx_tasks_task`: Struct do bx_tasks_task (%BxTasksTask{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_tasks_task \ %__MODULE__{}, attrs) do
    bx_tasks_task
    |> cast(attrs, [:author, :added, :changed, :published, :thumb, :title, :cat, :multicat, :text, :labels, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :favorites, :comments, :reports, :featured, :due_date, :tasks_list, :completed, :expired, :cf, :allow_view_to, :allow_comments, :status, :status_admin])
  end
end
