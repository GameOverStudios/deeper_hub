defmodule DeeperHub.Schema.BxPostsFile do
  @moduledoc """
  Schema para representação de bx_posts_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_posts_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_posts_file.

  ## Parâmetros 
    - `bx_posts_file`: Struct do bx_posts_file (pode ser %BxPostsFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_posts_file \ %__MODULE__{}, attrs) do
    bx_posts_file
  ...
  @doc """
  Changeset para atualização de um bx_posts_file existente.

  ## Parâmetros 
    - `bx_posts_file`: Struct do bx_posts_file (%BxPostsFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_posts_file \ %__MODULE__{}, attrs) do
    bx_posts_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
