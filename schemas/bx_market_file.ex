defmodule DeeperHub.Schema.BxMarketFile do
  @moduledoc """
  Schema para representação de bx_market_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_market_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_market_file.

  ## Parâmetros 
    - `bx_market_file`: Struct do bx_market_file (pode ser %BxMarketFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_market_file \ %__MODULE__{}, attrs) do
    bx_market_file
  ...
  @doc """
  Changeset para atualização de um bx_market_file existente.

  ## Parâmetros 
    - `bx_market_file`: Struct do bx_market_file (%BxMarketFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_market_file \ %__MODULE__{}, attrs) do
    bx_market_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
