defmodule DeeperHub.Schema.SysCmtsImage do
  @moduledoc """
  Schema para representação de sys_cmts_images no sistema
  ...
  @typedoc """
  Tipo que representa um sys_cmts_image no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo sys_cmts_image.

  ## Parâmetros 
    - `sys_cmts_image`: Struct do sys_cmts_image (pode ser %SysCmtsImage{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(sys_cmts_image \ %__MODULE__{}, attrs) do
    sys_cmts_image
  ...
  @doc """
  Changeset para atualização de um sys_cmts_image existente.

  ## Parâmetros 
    - `sys_cmts_image`: Struct do sys_cmts_image (%SysCmtsImage{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(sys_cmts_image \ %__MODULE__{}, attrs) do
    sys_cmts_image
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
