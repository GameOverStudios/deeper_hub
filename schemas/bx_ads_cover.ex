defmodule DeeperHub.Schema.BxAdsCover do
  @moduledoc """
  Schema para representação de bx_ads_covers no sistema
  ...
  @typedoc """
  Tipo que representa um bx_ads_cover no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_ads_cover.

  ## Parâmetros 
    - `bx_ads_cover`: Struct do bx_ads_cover (pode ser %BxAdsCover{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_ads_cover \ %__MODULE__{}, attrs) do
    bx_ads_cover
  ...
  @doc """
  Changeset para atualização de um bx_ads_cover existente.

  ## Parâmetros 
    - `bx_ads_cover`: Struct do bx_ads_cover (%BxAdsCover{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_ads_cover \ %__MODULE__{}, attrs) do
    bx_ads_cover
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
