defmodule DeeperHub.Schema.BxCnlCmt do
  @moduledoc """
  Schema para representação de bx_cnl_cmts no sistema
  ...
  @typedoc """
  Tipo que representa um bx_cnl_cmt no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_cnl_cmt.

  ## Parâmetros 
    - `bx_cnl_cmt`: Struct do bx_cnl_cmt (pode ser %BxCnlCmt{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_cnl_cmt \ %__MODULE__{}, attrs) do
    bx_cnl_cmt
  ...
  @doc """
  Changeset para atualização de um bx_cnl_cmt existente.

  ## Parâmetros 
    - `bx_cnl_cmt`: Struct do bx_cnl_cmt (%BxCnlCmt{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_cnl_cmt \ %__MODULE__{}, attrs) do
    bx_cnl_cmt
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
