defmodule DeeperHub.Schema.SysAgentsAssistantsChatsMessage do
  @moduledoc """
  Schema para representação de sys_agents_assistants_chats_messages no sistema
  ...
  schema "sys_agents_assistants_chats_messages" do
  ...
  @typedoc """
  Tipo que representa um sys_agents_assistants_chats_message no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo sys_agents_assistants_chats_message.

  ## Parâmetros 
    - `sys_agents_assistants_chats_message`: Struct do sys_agents_assistants_chats_message (pode ser %SysAgentsAssistantsChatsMessage{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(sys_agents_assistants_chats_message \ %__MODULE__{}, attrs) do
    sys_agents_assistants_chats_message
  ...
  @doc """
  Changeset para atualização de um sys_agents_assistants_chats_message existente.

  ## Parâmetros 
    - `sys_agents_assistants_chats_message`: Struct do sys_agents_assistants_chats_message (%SysAgentsAssistantsChatsMessage{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(sys_agents_assistants_chats_message \ %__MODULE__{}, attrs) do
    sys_agents_assistants_chats_message
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
