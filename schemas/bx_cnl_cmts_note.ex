defmodule DeeperHub.Schema.BxCnlCmtsNote do
  @moduledoc """
  Schema para representação de bx_cnl_cmts_notes no sistema
  ...
  @typedoc """
  Tipo que representa um bx_cnl_cmts_note no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_cnl_cmts_note.

  ## Parâmetros 
    - `bx_cnl_cmts_note`: Struct do bx_cnl_cmts_note (pode ser %BxCnlCmtsNote{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_cnl_cmts_note \ %__MODULE__{}, attrs) do
    bx_cnl_cmts_note
  ...
  @doc """
  Changeset para atualização de um bx_cnl_cmts_note existente.

  ## Parâmetros 
    - `bx_cnl_cmts_note`: Struct do bx_cnl_cmts_note (%BxCnlCmtsNote{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_cnl_cmts_note \ %__MODULE__{}, attrs) do
    bx_cnl_cmts_note
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned])
  end
end
