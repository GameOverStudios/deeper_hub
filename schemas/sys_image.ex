defmodule DeeperHub.Schema.SysImage do
  @moduledoc """
  Schema para representação de sys_images no sistema
  ...
  @typedoc """
  Tipo que representa um sys_image no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo sys_image.

  ## Parâmetros 
    - `sys_image`: Struct do sys_image (pode ser %SysImage{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(sys_image \ %__MODULE__{}, attrs) do
    sys_image
  ...
  @doc """
  Changeset para atualização de um sys_image existente.

  ## Parâmetros 
    - `sys_image`: Struct do sys_image (%SysImage{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(sys_image \ %__MODULE__{}, attrs) do
    sys_image
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
