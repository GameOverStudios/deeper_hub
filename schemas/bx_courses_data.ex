defmodule DeeperHub.Schema.BxCoursesData do
  @moduledoc """
  Schema para representação de bx_courses_datas no sistema
  ...
  @typedoc """
  Tipo que representa um bx_courses_data no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    author: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_courses_data.

  ## Parâmetros 
    - `bx_courses_data`: Struct do bx_courses_data (pode ser %BxCoursesData{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_courses_data \ %__MODULE__{}, attrs) do
    bx_courses_data
    |> cast(attrs, [:author, :added, :changed, :picture, :cover, :cover_data, :name, :cat, :desc, :labels, :location, :members, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :favorites, :comments, :reports, :featured, :cf, :join_confirmation, :allow_view_to, :allow_post_to, :status, :status_admin])
    |> validate_required([:author, :added, :changed, :picture, :cover, :cover_data, :name, :cat, :desc, :labels, :location])
  end

  @doc """
  Changeset para atualização de um bx_courses_data existente.

  ## Parâmetros 
    - `bx_courses_data`: Struct do bx_courses_data (%BxCoursesData{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_courses_data \ %__MODULE__{}, attrs) do
    bx_courses_data
    |> cast(attrs, [:author, :added, :changed, :picture, :cover, :cover_data, :name, :cat, :desc, :labels, :location, :members, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :favorites, :comments, :reports, :featured, :cf, :join_confirmation, :allow_view_to, :allow_post_to, :status, :status_admin])
  end
end
