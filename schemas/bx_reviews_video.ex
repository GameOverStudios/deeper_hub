defmodule DeeperHub.Schema.BxReviewsVideo do
  @moduledoc """
  Schema para representação de bx_reviews_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_reviews_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_reviews_video.

  ## Parâmetros 
    - `bx_reviews_video`: Struct do bx_reviews_video (pode ser %BxReviewsVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_reviews_video \ %__MODULE__{}, attrs) do
    bx_reviews_video
  ...
  @doc """
  Changeset para atualização de um bx_reviews_video existente.

  ## Parâmetros 
    - `bx_reviews_video`: Struct do bx_reviews_video (%BxReviewsVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_reviews_video \ %__MODULE__{}, attrs) do
    bx_reviews_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
