defmodule DeeperHub.Schema.BxEventsCmt do
  @moduledoc """
  Schema para representação de bx_events_cmts no sistema
  ...
  @typedoc """
  Tipo que representa um bx_events_cmt no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_events_cmt.

  ## Parâmetros 
    - `bx_events_cmt`: Struct do bx_events_cmt (pode ser %BxEventsCmt{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_events_cmt \ %__MODULE__{}, attrs) do
    bx_events_cmt
  ...
  @doc """
  Changeset para atualização de um bx_events_cmt existente.

  ## Parâmetros 
    - `bx_events_cmt`: Struct do bx_events_cmt (%BxEventsCmt{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_events_cmt \ %__MODULE__{}, attrs) do
    bx_events_cmt
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
