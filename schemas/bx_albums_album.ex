defmodule DeeperHub.Schema.BxAlbumsAlbum do
  @moduledoc """
  Schema para representação de bx_albums_albums no sistema
  ...
  @typedoc """
  Tipo que representa um bx_albums_album no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    author: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_albums_album.

  ## Parâmetros 
    - `bx_albums_album`: Struct do bx_albums_album (pode ser %BxAlbumsAlbum{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_albums_album \ %__MODULE__{}, attrs) do
    bx_albums_album
    |> cast(attrs, [:author, :added, :changed, :thumb, :title, :text, :labels, :location, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :favorites, :comments, :reports, :featured, :cf, :allow_view_to, :status, :status_admin])
    |> validate_required([:author, :added, :changed, :thumb, :title, :text, :labels, :location])
  end

  @doc """
  Changeset para atualização de um bx_albums_album existente.

  ## Parâmetros 
    - `bx_albums_album`: Struct do bx_albums_album (%BxAlbumsAlbum{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_albums_album \ %__MODULE__{}, attrs) do
    bx_albums_album
    |> cast(attrs, [:author, :added, :changed, :thumb, :title, :text, :labels, :location, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :favorites, :comments, :reports, :featured, :cf, :allow_view_to, :status, :status_admin])
  end
end
