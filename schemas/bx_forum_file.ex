defmodule DeeperHub.Schema.BxForumFile do
  @moduledoc """
  Schema para representação de bx_forum_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_forum_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_forum_file.

  ## Parâmetros 
    - `bx_forum_file`: Struct do bx_forum_file (pode ser %BxForumFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_forum_file \ %__MODULE__{}, attrs) do
    bx_forum_file
  ...
  @doc """
  Changeset para atualização de um bx_forum_file existente.

  ## Parâmetros 
    - `bx_forum_file`: Struct do bx_forum_file (%BxForumFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_forum_file \ %__MODULE__{}, attrs) do
    bx_forum_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
