defmodule DeeperHub.Schema.BxPostsCover do
  @moduledoc """
  Schema para representação de bx_posts_covers no sistema
  ...
  @typedoc """
  Tipo que representa um bx_posts_cover no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_posts_cover.

  ## Parâmetros 
    - `bx_posts_cover`: Struct do bx_posts_cover (pode ser %BxPostsCover{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_posts_cover \ %__MODULE__{}, attrs) do
    bx_posts_cover
  ...
  @doc """
  Changeset para atualização de um bx_posts_cover existente.

  ## Parâmetros 
    - `bx_posts_cover`: Struct do bx_posts_cover (%BxPostsCover{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_posts_cover \ %__MODULE__{}, attrs) do
    bx_posts_cover
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private, :dimensions])
    |> unique_constraint(:remote_id)
  end
