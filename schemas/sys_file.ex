defmodule DeeperHub.Schema.SysFile do
  @moduledoc """
  Schema para representação de sys_files no sistema
  ...
  @typedoc """
  Tipo que representa um sys_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo sys_file.

  ## Parâmetros 
    - `sys_file`: Struct do sys_file (pode ser %SysFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(sys_file \ %__MODULE__{}, attrs) do
    sys_file
  ...
  @doc """
  Changeset para atualização de um sys_file existente.

  ## Parâmetros 
    - `sys_file`: Struct do sys_file (%SysFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(sys_file \ %__MODULE__{}, attrs) do
    sys_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
