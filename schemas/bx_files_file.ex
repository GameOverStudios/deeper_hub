defmodule DeeperHub.Schema.BxFilesFile do
  @moduledoc """
  Schema para representação de bx_files_files no sistema
  ...
  @typedoc """
  Tipo que representa um bx_files_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_files_file.

  ## Parâmetros 
    - `bx_files_file`: Struct do bx_files_file (pode ser %BxFilesFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_files_file \ %__MODULE__{}, attrs) do
    bx_files_file
  ...
  @doc """
  Changeset para atualização de um bx_files_file existente.

  ## Parâmetros 
    - `bx_files_file`: Struct do bx_files_file (%BxFilesFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_files_file \ %__MODULE__{}, attrs) do
    bx_files_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
