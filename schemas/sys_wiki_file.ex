defmodule DeeperHub.Schema.SysWikiFile do
  @moduledoc """
  Schema para representação de sys_wiki_files no sistema
  ...
  @typedoc """
  Tipo que representa um sys_wiki_file no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo sys_wiki_file.

  ## Parâmetros 
    - `sys_wiki_file`: Struct do sys_wiki_file (pode ser %SysWikiFile{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(sys_wiki_file \ %__MODULE__{}, attrs) do
    sys_wiki_file
  ...
  @doc """
  Changeset para atualização de um sys_wiki_file existente.

  ## Parâmetros 
    - `sys_wiki_file`: Struct do sys_wiki_file (%SysWikiFile{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(sys_wiki_file \ %__MODULE__{}, attrs) do
    sys_wiki_file
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
