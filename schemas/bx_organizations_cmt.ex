defmodule DeeperHub.Schema.BxOrganizationsCmt do
  @moduledoc """
  Schema para representação de bx_organizations_cmts no sistema
  ...
  schema "bx_organizations_cmts" do
  ...
  @typedoc """
  Tipo que representa um bx_organizations_cmt no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
    cmt_id: integer() | nil,
  ...
  @doc """
  Changeset para criação de um novo bx_organizations_cmt.

  ## Parâmetros 
    - `bx_organizations_cmt`: Struct do bx_organizations_cmt (pode ser %BxOrganizationsCmt{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_organizations_cmt \ %__MODULE__{}, attrs) do
    bx_organizations_cmt
  ...
  @doc """
  Changeset para atualização de um bx_organizations_cmt existente.

  ## Parâmetros 
    - `bx_organizations_cmt`: Struct do bx_organizations_cmt (%BxOrganizationsCmt{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_organizations_cmt \ %__MODULE__{}, attrs) do
    bx_organizations_cmt
    |> cast(attrs, [:cmt_id, :cmt_parent_id, :cmt_vparent_id, :cmt_object_id, :cmt_author_id, :cmt_level, :cmt_text, :cmt_mood, :cmt_rate, :cmt_rate_count, :cmt_time, :cmt_replies, :cmt_pinned, :cmt_cf])
  end
end
