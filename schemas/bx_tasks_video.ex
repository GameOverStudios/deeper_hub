defmodule DeeperHub.Schema.BxTasksVideo do
  @moduledoc """
  Schema para representação de bx_tasks_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_tasks_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_tasks_video.

  ## Parâmetros 
    - `bx_tasks_video`: Struct do bx_tasks_video (pode ser %BxTasksVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_tasks_video \ %__MODULE__{}, attrs) do
    bx_tasks_video
  ...
  @doc """
  Changeset para atualização de um bx_tasks_video existente.

  ## Parâmetros 
    - `bx_tasks_video`: Struct do bx_tasks_video (%BxTasksVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_tasks_video \ %__MODULE__{}, attrs) do
    bx_tasks_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
