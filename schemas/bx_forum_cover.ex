defmodule DeeperHub.Schema.BxForumCover do
  @moduledoc """
  Schema para representação de bx_forum_covers no sistema
  ...
  @typedoc """
  Tipo que representa um bx_forum_cover no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_forum_cover.

  ## Parâmetros 
    - `bx_forum_cover`: Struct do bx_forum_cover (pode ser %BxForumCover{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_forum_cover \ %__MODULE__{}, attrs) do
    bx_forum_cover
  ...
  @doc """
  Changeset para atualização de um bx_forum_cover existente.

  ## Parâmetros 
    - `bx_forum_cover`: Struct do bx_forum_cover (%BxForumCover{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_forum_cover \ %__MODULE__{}, attrs) do
    bx_forum_cover
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
