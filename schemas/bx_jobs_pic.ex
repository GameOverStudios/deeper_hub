defmodule DeeperHub.Schema.BxJobsPic do
  @moduledoc """
  Schema para representação de bx_jobs_pics no sistema
  ...
  @typedoc """
  Tipo que representa um bx_jobs_pic no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_jobs_pic.

  ## Parâmetros 
    - `bx_jobs_pic`: Struct do bx_jobs_pic (pode ser %BxJobsPic{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_jobs_pic \ %__MODULE__{}, attrs) do
    bx_jobs_pic
  ...
  @doc """
  Changeset para atualização de um bx_jobs_pic existente.

  ## Parâmetros 
    - `bx_jobs_pic`: Struct do bx_jobs_pic (%BxJobsPic{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_jobs_pic \ %__MODULE__{}, attrs) do
    bx_jobs_pic
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
