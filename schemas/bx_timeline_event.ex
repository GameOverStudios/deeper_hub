defmodule DeeperHub.Schema.BxTimelineEvent do
  @moduledoc """
  Schema para representação de bx_timeline_events no sistema
  ...
  @typedoc """
  Tipo que representa um bx_timeline_event no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_timeline_event.

  ## Parâmetros 
    - `bx_timeline_event`: Struct do bx_timeline_event (pode ser %BxTimelineEvent{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_timeline_event \ %__MODULE__{}, attrs) do
    bx_timeline_event
  ...
  @doc """
  Changeset para atualização de um bx_timeline_event existente.

  ## Parâmetros 
    - `bx_timeline_event`: Struct do bx_timeline_event (%BxTimelineEvent{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_timeline_event \ %__MODULE__{}, attrs) do
    bx_timeline_event
    |> cast(attrs, [:owner_id, :system, :type, :action, :object_id, :object_owner_id, :object_privacy_view, :object_cf, :content, :source, :title, :description, :labels, :location, :views, :rate, :votes, :rrate, :rvotes, :score, :sc_up, :sc_down, :comments, :reports, :reposts, :date, :published, :reacted, :status, :status_admin, :active, :pinned, :sticked, :promoted])
  end
end
