defmodule DeeperHub.Schema.BxCnlPic do
  @moduledoc """
  Schema para representação de bx_cnl_pics no sistema
  ...
  @typedoc """
  Tipo que representa um bx_cnl_pic no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_cnl_pic.

  ## Parâmetros 
    - `bx_cnl_pic`: Struct do bx_cnl_pic (pode ser %BxCnlPic{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_cnl_pic \ %__MODULE__{}, attrs) do
    bx_cnl_pic
  ...
  @doc """
  Changeset para atualização de um bx_cnl_pic existente.

  ## Parâmetros 
    - `bx_cnl_pic`: Struct do bx_cnl_pic (%BxCnlPic{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_cnl_pic \ %__MODULE__{}, attrs) do
    bx_cnl_pic
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
