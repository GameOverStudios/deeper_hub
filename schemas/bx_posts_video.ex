defmodule DeeperHub.Schema.BxPostsVideo do
  @moduledoc """
  Schema para representação de bx_posts_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_posts_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_posts_video.

  ## Parâmetros 
    - `bx_posts_video`: Struct do bx_posts_video (pode ser %BxPostsVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_posts_video \ %__MODULE__{}, attrs) do
    bx_posts_video
  ...
  @doc """
  Changeset para atualização de um bx_posts_video existente.

  ## Parâmetros 
    - `bx_posts_video`: Struct do bx_posts_video (%BxPostsVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_posts_video \ %__MODULE__{}, attrs) do
    bx_posts_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
