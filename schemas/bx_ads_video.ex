defmodule DeeperHub.Schema.BxAdsVideo do
  @moduledoc """
  Schema para representação de bx_ads_videos no sistema
  ...
  @typedoc """
  Tipo que representa um bx_ads_video no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_ads_video.

  ## Parâmetros 
    - `bx_ads_video`: Struct do bx_ads_video (pode ser %BxAdsVideo{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_ads_video \ %__MODULE__{}, attrs) do
    bx_ads_video
  ...
  @doc """
  Changeset para atualização de um bx_ads_video existente.

  ## Parâmetros 
    - `bx_ads_video`: Struct do bx_ads_video (%BxAdsVideo{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_ads_video \ %__MODULE__{}, attrs) do
    bx_ads_video
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
