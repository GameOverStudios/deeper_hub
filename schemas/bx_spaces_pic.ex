defmodule DeeperHub.Schema.BxSpacesPic do
  @moduledoc """
  Schema para representação de bx_spaces_pics no sistema
  ...
  @typedoc """
  Tipo que representa um bx_spaces_pic no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_spaces_pic.

  ## Parâmetros 
    - `bx_spaces_pic`: Struct do bx_spaces_pic (pode ser %BxSpacesPic{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_spaces_pic \ %__MODULE__{}, attrs) do
    bx_spaces_pic
  ...
  @doc """
  Changeset para atualização de um bx_spaces_pic existente.

  ## Parâmetros 
    - `bx_spaces_pic`: Struct do bx_spaces_pic (%BxSpacesPic{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_spaces_pic \ %__MODULE__{}, attrs) do
    bx_spaces_pic
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :dimensions, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
