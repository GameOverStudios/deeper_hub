defmodule DeeperHub.Schema.BxCoursesPic do
  @moduledoc """
  Schema para representação de bx_courses_pics no sistema
  ...
  @typedoc """
  Tipo que representa um bx_courses_pic no sistema
  """
  @type t :: %__MODULE__{
    id: Ecto.UUID.t(),
  ...
  @doc """
  Changeset para criação de um novo bx_courses_pic.

  ## Parâmetros 
    - `bx_courses_pic`: Struct do bx_courses_pic (pode ser %BxCoursesPic{} ou %{})
    - `attrs`: Mapa com os atributos para criação

  ## Retorno 
    - Changeset válido ou inválido
  """
  def create_changeset(bx_courses_pic \ %__MODULE__{}, attrs) do
    bx_courses_pic
  ...
  @doc """
  Changeset para atualização de um bx_courses_pic existente.

  ## Parâmetros 
    - `bx_courses_pic`: Struct do bx_courses_pic (%BxCoursesPic{})
    - `attrs`: Mapa com os atributos para atualização

  ## Retorno 
    - Changeset válido ou inválido
  """
  def update_changeset(bx_courses_pic \ %__MODULE__{}, attrs) do
    bx_courses_pic
    |> cast(attrs, [:profile_id, :remote_id, :path, :file_name, :mime_type, :ext, :size, :added, :modified, :private])
    |> unique_constraint(:remote_id)
  end
