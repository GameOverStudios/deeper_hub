defmodule Repo.Migrations.CreateBxFilesReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_files_reports_track, primary_key: false) do
    ...
    create index(:bx_files_reports_track, [:object_id])
  end
end
