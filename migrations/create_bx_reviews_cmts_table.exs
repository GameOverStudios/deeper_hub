defmodule Repo.Migrations.CreateBxReviewsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_cmts, primary_key: false) do
    ...
    create index(:bx_reviews_cmts, [:cmt_object_id])
    create index(:bx_reviews_cmts, [:cmt_text])
  end
end
