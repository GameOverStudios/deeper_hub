defmodule Repo.Migrations.CreateBxForumCmts do
  use Ecto.Migration

  def change do
    create table(:bx_forum_cmts, primary_key: false) do
    ...
    create index(:bx_forum_cmts, [:cmt_object_id])
    create index(:bx_forum_cmts, [:cmt_text])
  end
end
