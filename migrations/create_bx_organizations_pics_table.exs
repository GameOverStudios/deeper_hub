defmodule Repo.Migrations.CreateBxOrganizationsPics do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_pics, primary_key: false) do
    ...
    create index(:bx_organizations_pics, [:remote_id], unique: true)
  end
end
