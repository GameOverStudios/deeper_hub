defmodule Repo.Migrations.CreateBxCoursesCmts do
  use Ecto.Migration

  def change do
    create table(:bx_courses_cmts, primary_key: false) do
    ...
    create index(:bx_courses_cmts, [:cmt_object_id])
    create index(:bx_courses_cmts, [:cmt_text])
  end
end
