defmodule Repo.Migrations.CreateBxJobsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_jobs_cmts, primary_key: false) do
    ...
    create index(:bx_jobs_cmts, [:cmt_object_id])
    create index(:bx_jobs_cmts, [:cmt_text])
  end
end
