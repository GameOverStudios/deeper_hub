defmodule Repo.Migrations.CreateBxPollsEntries do
  use Ecto.Migration

  def change do
    create table(:bx_polls_entries, primary_key: false) do
      ...
      add :anonymous, :integer, null: false, default: 0
      add :hidden_results, :integer, null: false, default: 0
      add :status, :string, null: false, default: "active"
      add :status_admin, :string, null: false, default: "active"
      timestamps()
    end
    create index(:bx_polls_entries, [:text])
  end
end
