defmodule Repo.Migrations.CreateBxStoriesReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_stories_reactions_track, primary_key: false) do
    ...
    create index(:bx_stories_reactions_track, [:object_id])
  end
end
