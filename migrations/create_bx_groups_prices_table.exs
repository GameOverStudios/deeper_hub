defmodule Repo.Migrations.CreateBxGroupsPrices do
  use Ecto.Migration

  def change do
    create table(:bx_groups_prices, primary_key: false) do
    ...
    create index(:bx_groups_prices, [:profile_id])
    create index(:bx_groups_prices, [:name], unique: true)
  end
end
