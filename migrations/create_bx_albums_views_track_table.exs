defmodule Repo.Migrations.CreateBxAlbumsViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_albums_views_track, primary_key: false) do
    ...
    create index(:bx_albums_views_track, [:object_id])
  end
end
