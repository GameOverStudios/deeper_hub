defmodule Repo.Migrations.CreateBxReviewsFiles do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_files, primary_key: false) do
    ...
    create index(:bx_reviews_files, [:remote_id], unique: true)
  end
end
