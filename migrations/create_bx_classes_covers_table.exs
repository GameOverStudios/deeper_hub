defmodule Repo.Migrations.CreateBxClassesCovers do
  use Ecto.Migration

  def change do
    create table(:bx_classes_covers, primary_key: false) do
    ...
    create index(:bx_classes_covers, [:remote_id], unique: true)
  end
end
