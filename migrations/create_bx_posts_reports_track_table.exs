defmodule Repo.Migrations.CreateBxPostsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_posts_reports_track, primary_key: false) do
    ...
    create index(:bx_posts_reports_track, [:object_id])
  end
end
