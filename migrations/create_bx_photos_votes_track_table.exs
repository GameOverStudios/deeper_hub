defmodule Repo.Migrations.CreateBxPhotosVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_photos_votes_track, primary_key: false) do
    ...
    create index(:bx_photos_votes_track, [:object_id])
  end
end
