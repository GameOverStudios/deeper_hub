defmodule Repo.Migrations.CreateBxAdsFavoritesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_ads_favorites_track, primary_key: false) do
    ...
    create index(:bx_ads_favorites_track, [:object_id])
  end
end
