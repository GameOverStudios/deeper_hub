defmodule Repo.Migrations.CreateBxForumPollsAnswersVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_forum_polls_answers_votes_track, primary_key: false) do
    ...
    create index(:bx_forum_polls_answers_votes_track, [:object_id])
  end
end
