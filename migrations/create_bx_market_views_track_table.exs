defmodule Repo.Migrations.CreateBxMarketViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_market_views_track, primary_key: false) do
    ...
    create index(:bx_market_views_track, [:object_id])
  end
end
