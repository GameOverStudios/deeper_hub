defmodule Repo.Migrations.CreateSysCmtsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:sys_cmts_scores_track, primary_key: false) do
    ...
    create index(:sys_cmts_scores_track, [:object_id])
  end
end
