defmodule Repo.Migrations.CreateBxStoriesViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_stories_views_track, primary_key: false) do
    ...
    create index(:bx_stories_views_track, [:object_id])
  end
end
