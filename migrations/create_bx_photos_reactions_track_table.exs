defmodule Repo.Migrations.CreateBxPhotosReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_photos_reactions_track, primary_key: false) do
    ...
    create index(:bx_photos_reactions_track, [:object_id])
  end
end
