defmodule Repo.Migrations.CreateBxStoriesPhotosResized do
  use Ecto.Migration

  def change do
    create table(:bx_stories_photos_resized, primary_key: false) do
    ...
    create index(:bx_stories_photos_resized, [:remote_id], unique: true)
  end
end
