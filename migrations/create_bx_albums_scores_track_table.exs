defmodule Repo.Migrations.CreateBxAlbumsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_albums_scores_track, primary_key: false) do
    ...
    create index(:bx_albums_scores_track, [:object_id])
  end
end
