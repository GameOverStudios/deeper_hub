defmodule Repo.Migrations.CreateBxJobsFavoritesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_jobs_favorites_track, primary_key: false) do
    ...
    create index(:bx_jobs_favorites_track, [:object_id])
  end
end
