defmodule Repo.Migrations.CreateBxTimelineReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_reports_track, primary_key: false) do
    ...
    create index(:bx_timeline_reports_track, [:object_id])
  end
end
