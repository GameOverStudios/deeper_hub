defmodule Repo.Migrations.CreateBxForumPhotosResized do
  use Ecto.Migration

  def change do
    create table(:bx_forum_photos_resized, primary_key: false) do
    ...
    create index(:bx_forum_photos_resized, [:remote_id], unique: true)
  end
end
