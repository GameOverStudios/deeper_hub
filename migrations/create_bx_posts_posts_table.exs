defmodule Repo.Migrations.CreateBxPostsPosts do
  use Ecto.Migration

  def change do
    create table(:bx_posts_posts, primary_key: false) do
      ...
      add :abstract, :string, null: false
    ...
    create index(:bx_posts_posts, [:title])
  end
end
