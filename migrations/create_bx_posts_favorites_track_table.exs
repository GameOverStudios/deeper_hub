defmodule Repo.Migrations.CreateBxPostsFavoritesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_posts_favorites_track, primary_key: false) do
    ...
    create index(:bx_posts_favorites_track, [:object_id])
  end
end
