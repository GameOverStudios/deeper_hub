defmodule Repo.Migrations.CreateBxGlossaryCmts do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_cmts, primary_key: false) do
    ...
    create index(:bx_glossary_cmts, [:cmt_object_id])
    create index(:bx_glossary_cmts, [:cmt_text])
  end
end
