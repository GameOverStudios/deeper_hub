defmodule Repo.Migrations.CreateBxConvosPhotosResized do
  use Ecto.Migration

  def change do
    create table(:bx_convos_photos_resized, primary_key: false) do
    ...
    create index(:bx_convos_photos_resized, [:remote_id], unique: true)
  end
end
