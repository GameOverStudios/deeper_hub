defmodule Repo.Migrations.CreateBxPollsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_polls_reports_track, primary_key: false) do
    ...
    create index(:bx_polls_reports_track, [:object_id])
  end
end
