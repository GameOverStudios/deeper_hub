defmodule Repo.Migrations.CreateBxVideosViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_videos_views_track, primary_key: false) do
    ...
    create index(:bx_videos_views_track, [:object_id])
  end
end
