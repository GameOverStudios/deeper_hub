defmodule Repo.Migrations.CreateBxPersonsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_persons_reactions_track, primary_key: false) do
    ...
    create index(:bx_persons_reactions_track, [:object_id])
  end
end
