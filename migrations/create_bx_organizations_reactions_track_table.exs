defmodule Repo.Migrations.CreateBxOrganizationsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_reactions_track, primary_key: false) do
    ...
    create index(:bx_organizations_reactions_track, [:object_id])
  end
end
