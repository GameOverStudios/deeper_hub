defmodule Repo.Migrations.CreateBxAlbumsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_albums_cmts, primary_key: false) do
    ...
    create index(:bx_albums_cmts, [:cmt_object_id])
    create index(:bx_albums_cmts, [:cmt_text])
  end
end
