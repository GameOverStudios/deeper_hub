defmodule Repo.Migrations.CreateBxPollsFavoritesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_polls_favorites_track, primary_key: false) do
    ...
    create index(:bx_polls_favorites_track, [:object_id])
  end
end
