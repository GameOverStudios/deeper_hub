defmodule Repo.Migrations.CreateBxVideosCmts do
  use Ecto.Migration

  def change do
    create table(:bx_videos_cmts, primary_key: false) do
    ...
    create index(:bx_videos_cmts, [:cmt_object_id])
    create index(:bx_videos_cmts, [:cmt_text])
  end
end
