defmodule Repo.Migrations.CreateBxGroupsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_groups_scores_track, primary_key: false) do
    ...
    create index(:bx_groups_scores_track, [:object_id])
  end
end
