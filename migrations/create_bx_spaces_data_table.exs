defmodule Repo.Migrations.CreateBxSpacesData do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_data, primary_key: false) do
      add :id, :binary_id, primary_key: true
      add :author, :integer, null: false
      add :parent_space, :integer, null: false, default: 0
      ...
      add :space_name, :string, null: false
      add :space_cat, :integer, null: false
      add :space_desc, :string, null: false
      ...
      add :stg_tabs, :string, null: false
      timestamps()
    end
    create index(:bx_spaces_data, [:space_name])
  end
end
