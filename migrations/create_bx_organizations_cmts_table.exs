defmodule Repo.Migrations.CreateBxOrganizationsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_cmts, primary_key: false) do
    ...
    create index(:bx_organizations_cmts, [:cmt_object_id])
    create index(:bx_organizations_cmts, [:cmt_text])
  end
end
