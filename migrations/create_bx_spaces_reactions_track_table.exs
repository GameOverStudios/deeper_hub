defmodule Repo.Migrations.CreateBxSpacesReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_reactions_track, primary_key: false) do
    ...
    create index(:bx_spaces_reactions_track, [:object_id])
  end
end
