defmodule Repo.Migrations.CreateBxPhotosPhotos do
  use Ecto.Migration

  def change do
    create table(:bx_photos_photos, primary_key: false) do
    ...
    create index(:bx_photos_photos, [:remote_id], unique: true)
  end
end
