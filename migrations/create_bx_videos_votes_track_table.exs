defmodule Repo.Migrations.CreateBxVideosVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_videos_votes_track, primary_key: false) do
    ...
    create index(:bx_videos_votes_track, [:object_id])
  end
end
