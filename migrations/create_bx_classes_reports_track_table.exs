defmodule Repo.Migrations.CreateBxClassesReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_classes_reports_track, primary_key: false) do
    ...
    create index(:bx_classes_reports_track, [:object_id])
  end
end
