defmodule Repo.Migrations.CreateBxAlbumsReportsMediaTrack do
  use Ecto.Migration

  def change do
    create table(:bx_albums_reports_media_track, primary_key: false) do
    ...
    create index(:bx_albums_reports_media_track, [:object_id])
  end
end
