defmodule Repo.Migrations.CreateBxCnlCmts do
  use Ecto.Migration

  def change do
    create table(:bx_cnl_cmts, primary_key: false) do
    ...
    create index(:bx_cnl_cmts, [:cmt_object_id])
    create index(:bx_cnl_cmts, [:cmt_text])
  end
end
