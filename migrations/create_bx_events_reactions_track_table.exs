defmodule Repo.Migrations.CreateBxEventsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_events_reactions_track, primary_key: false) do
    ...
    create index(:bx_events_reactions_track, [:object_id])
  end
end
