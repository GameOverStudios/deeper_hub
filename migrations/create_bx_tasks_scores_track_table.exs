defmodule Repo.Migrations.CreateBxTasksScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_tasks_scores_track, primary_key: false) do
    ...
    create index(:bx_tasks_scores_track, [:object_id])
  end
end
