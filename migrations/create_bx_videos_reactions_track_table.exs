defmodule Repo.Migrations.CreateBxVideosReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_videos_reactions_track, primary_key: false) do
    ...
    create index(:bx_videos_reactions_track, [:object_id])
  end
end
