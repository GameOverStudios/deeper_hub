defmodule Repo.Migrations.CreateBxWorkspacesVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_workspaces_votes_track, primary_key: false) do
    ...
    create index(:bx_workspaces_votes_track, [:object_id])
  end
end
