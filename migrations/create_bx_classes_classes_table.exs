defmodule Repo.Migrations.CreateBxClassesClasses do
  use Ecto.Migration

  def change do
    create table(:bx_classes_classes, primary_key: false) do
      ...
      add :avail, :integer, null: false
      add :cmts, :integer, null: false
      add :completed_when, :integer, null: false
    ...
    create index(:bx_classes_classes, [:title])
  end
end
