defmodule Repo.Migrations.CreateBxGroupsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_groups_reactions_track, primary_key: false) do
    ...
    create index(:bx_groups_reactions_track, [:object_id])
  end
end
