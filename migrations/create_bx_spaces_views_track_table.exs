defmodule Repo.Migrations.CreateBxSpacesViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_views_track, primary_key: false) do
    ...
    create index(:bx_spaces_views_track, [:object_id])
  end
end
