defmodule Repo.Migrations.CreateBxOrganizationsAdmins do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_admins, primary_key: false) do
    ...
    create index(:bx_organizations_admins, [:group_profile_id])
  end
end
