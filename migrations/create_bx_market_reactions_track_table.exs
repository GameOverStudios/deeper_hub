defmodule Repo.Migrations.CreateBxMarketReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_market_reactions_track, primary_key: false) do
    ...
    create index(:bx_market_reactions_track, [:object_id])
  end
end
