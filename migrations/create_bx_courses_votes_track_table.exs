defmodule Repo.Migrations.CreateBxCoursesVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_courses_votes_track, primary_key: false) do
    ...
    create index(:bx_courses_votes_track, [:object_id])
  end
end
