defmodule Repo.Migrations.CreateBxVideosEntries do
  use Ecto.Migration

  def change do
    create table(:bx_videos_entries, primary_key: false) do
      ...
      add :poster, :integer, null: false, default: 0
      add :video_source, :string, null: false, default: "upload"
      add :video, :integer, null: false, default: 0
      add :video_embed, :string
      add :video_embed_data, :string
    ...
    create index(:bx_videos_entries, [:title])
  end
end
