defmodule Repo.Migrations.CreateBxVideosReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_videos_reports_track, primary_key: false) do
    ...
    create index(:bx_videos_reports_track, [:object_id])
  end
end
