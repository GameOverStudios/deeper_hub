defmodule Repo.Migrations.CreateBxVideosSvotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_videos_svotes_track, primary_key: false) do
    ...
    create index(:bx_videos_svotes_track, [:object_id])
  end
end
