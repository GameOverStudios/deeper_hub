defmodule Repo.Migrations.CreateBxAdsPromoLicensesDeleted do
  use Ecto.Migration

  def change do
    create table(:bx_ads_promo_licenses_deleted, primary_key: false) do
    ...
    create index(:bx_ads_promo_licenses_deleted, [:license])
  end
end
