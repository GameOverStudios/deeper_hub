defmodule Repo.Migrations.CreateBxWorkspacesViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_workspaces_views_track, primary_key: false) do
    ...
    create index(:bx_workspaces_views_track, [:object_id])
  end
end
