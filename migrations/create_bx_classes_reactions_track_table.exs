defmodule Repo.Migrations.CreateBxClassesReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_classes_reactions_track, primary_key: false) do
    ...
    create index(:bx_classes_reactions_track, [:object_id])
  end
end
