defmodule Repo.Migrations.CreateBxMarketCmts do
  use Ecto.Migration

  def change do
    create table(:bx_market_cmts, primary_key: false) do
    ...
    create index(:bx_market_cmts, [:cmt_object_id])
    create index(:bx_market_cmts, [:cmt_text])
  end
end
