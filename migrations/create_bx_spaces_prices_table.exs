defmodule Repo.Migrations.CreateBxSpacesPrices do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_prices, primary_key: false) do
    ...
    create index(:bx_spaces_prices, [:profile_id])
    create index(:bx_spaces_prices, [:name], unique: true)
  end
end
