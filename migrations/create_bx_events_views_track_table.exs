defmodule Repo.Migrations.CreateBxEventsViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_events_views_track, primary_key: false) do
    ...
    create index(:bx_events_views_track, [:object_id])
  end
end
