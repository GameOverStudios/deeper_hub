defmodule Repo.Migrations.CreateBxPersonsPictures do
  use Ecto.Migration

  def change do
    create table(:bx_persons_pictures, primary_key: false) do
    ...
    create index(:bx_persons_pictures, [:remote_id], unique: true)
  end
end
