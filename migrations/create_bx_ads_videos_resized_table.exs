defmodule Repo.Migrations.CreateBxAdsVideosResized do
  use Ecto.Migration

  def change do
    create table(:bx_ads_videos_resized, primary_key: false) do
    ...
    create index(:bx_ads_videos_resized, [:remote_id], unique: true)
  end
end
