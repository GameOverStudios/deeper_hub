defmodule Repo.Migrations.CreateBxTimelineVideos do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_videos, primary_key: false) do
    ...
    create index(:bx_timeline_videos, [:remote_id], unique: true)
  end
end
