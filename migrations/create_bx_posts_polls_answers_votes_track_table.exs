defmodule Repo.Migrations.CreateBxPostsPollsAnswersVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_posts_polls_answers_votes_track, primary_key: false) do
    ...
    create index(:bx_posts_polls_answers_votes_track, [:object_id])
  end
end
