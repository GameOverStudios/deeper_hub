defmodule Repo.Migrations.CreateBxClassesVideos do
  use Ecto.Migration

  def change do
    create table(:bx_classes_videos, primary_key: false) do
    ...
    create index(:bx_classes_videos, [:remote_id], unique: true)
  end
end
