defmodule Repo.Migrations.CreateBxOrganizationsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_scores_track, primary_key: false) do
    ...
    create index(:bx_organizations_scores_track, [:object_id])
  end
end
