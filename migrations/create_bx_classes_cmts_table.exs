defmodule Repo.Migrations.CreateBxClassesCmts do
  use Ecto.Migration

  def change do
    create table(:bx_classes_cmts, primary_key: false) do
    ...
    create index(:bx_classes_cmts, [:cmt_object_id])
    create index(:bx_classes_cmts, [:cmt_text])
  end
end
