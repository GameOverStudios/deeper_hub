defmodule Repo.Migrations.CreateBxConvosViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_convos_views_track, primary_key: false) do
    ...
    create index(:bx_convos_views_track, [:object_id])
  end
end
