defmodule Repo.Migrations.CreateSysImagesCustom do
  use Ecto.Migration

  def change do
    create table(:sys_images_custom, primary_key: false) do
    ...
    create index(:sys_images_custom, [:remote_id], unique: true)
  end
end
