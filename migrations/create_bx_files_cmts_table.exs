defmodule Repo.Migrations.CreateBxFilesCmts do
  use Ecto.Migration

  def change do
    create table(:bx_files_cmts, primary_key: false) do
    ...
    create index(:bx_files_cmts, [:cmt_object_id])
    create index(:bx_files_cmts, [:cmt_text])
  end
end
