defmodule Repo.Migrations.CreateBxMarketScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_market_scores_track, primary_key: false) do
    ...
    create index(:bx_market_scores_track, [:object_id])
  end
end
