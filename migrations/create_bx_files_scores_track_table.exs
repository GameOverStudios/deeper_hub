defmodule Repo.Migrations.CreateBxFilesScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_files_scores_track, primary_key: false) do
    ...
    create index(:bx_files_scores_track, [:object_id])
  end
end
