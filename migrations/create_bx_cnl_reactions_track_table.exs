defmodule Repo.Migrations.CreateBxCnlReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_cnl_reactions_track, primary_key: false) do
    ...
    create index(:bx_cnl_reactions_track, [:object_id])
  end
end
