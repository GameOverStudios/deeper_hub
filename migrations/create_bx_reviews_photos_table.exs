defmodule Repo.Migrations.CreateBxReviewsPhotos do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_photos, primary_key: false) do
    ...
    create index(:bx_reviews_photos, [:remote_id], unique: true)
  end
end
