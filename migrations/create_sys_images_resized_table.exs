defmodule Repo.Migrations.CreateSysImagesResized do
  use Ecto.Migration

  def change do
    create table(:sys_images_resized, primary_key: false) do
    ...
    create index(:sys_images_resized, [:remote_id], unique: true)
  end
end
