defmodule Repo.Migrations.CreateBxReviewsSvotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_svotes_track, primary_key: false) do
    ...
    create index(:bx_reviews_svotes_track, [:object_id])
  end
end
