defmodule Repo.Migrations.CreateBxPostsSoundsResized do
  use Ecto.Migration

  def change do
    create table(:bx_posts_sounds_resized, primary_key: false) do
    ...
    create index(:bx_posts_sounds_resized, [:remote_id], unique: true)
  end
end
