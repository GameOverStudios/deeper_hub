defmodule Repo.Migrations.CreateBxReviewsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_reports_track, primary_key: false) do
    ...
    create index(:bx_reviews_reports_track, [:object_id])
  end
end
