defmodule Repo.Migrations.CreateBxPollsVotesSubentriesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_polls_votes_subentries_track, primary_key: false) do
    ...
    create index(:bx_polls_votes_subentries_track, [:object_id])
  end
end
