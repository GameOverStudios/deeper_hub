defmodule Repo.Migrations.CreateBxSpacesReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_reports_track, primary_key: false) do
    ...
    create index(:bx_spaces_reports_track, [:object_id])
  end
end
