defmodule Repo.Migrations.CreateBxAdsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_ads_reactions_track, primary_key: false) do
    ...
    create index(:bx_ads_reactions_track, [:object_id])
  end
end
