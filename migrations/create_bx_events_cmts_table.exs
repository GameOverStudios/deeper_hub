defmodule Repo.Migrations.CreateBxEventsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_events_cmts, primary_key: false) do
    ...
    create index(:bx_events_cmts, [:cmt_object_id])
    create index(:bx_events_cmts, [:cmt_text])
  end
end
