defmodule Repo.Migrations.CreateBxReviewsVideos do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_videos, primary_key: false) do
    ...
    create index(:bx_reviews_videos, [:remote_id], unique: true)
  end
end
