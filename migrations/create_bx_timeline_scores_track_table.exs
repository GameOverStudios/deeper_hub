defmodule Repo.Migrations.CreateBxTimelineScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_scores_track, primary_key: false) do
    ...
    create index(:bx_timeline_scores_track, [:object_id])
  end
end
