defmodule Repo.Migrations.CreateBxFilesFavoritesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_files_favorites_track, primary_key: false) do
    ...
    create index(:bx_files_favorites_track, [:object_id])
  end
end
