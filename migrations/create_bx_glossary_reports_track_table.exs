defmodule Repo.Migrations.CreateBxGlossaryReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_reports_track, primary_key: false) do
    ...
    create index(:bx_glossary_reports_track, [:object_id])
  end
end
