defmodule Repo.Migrations.CreateBxCoursesReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_courses_reactions_track, primary_key: false) do
    ...
    create index(:bx_courses_reactions_track, [:object_id])
  end
end
