defmodule Repo.Migrations.CreateBxPaymentSubscriptionsDeleted do
  use Ecto.Migration

  def change do
    create table(:bx_payment_subscriptions_deleted, primary_key: false) do
    ...
    create index(:bx_payment_subscriptions_deleted, [:pending_id], unique: true)
  end
end
