defmodule Repo.Migrations.CreateSysAccountsPictures do
  use Ecto.Migration

  def change do
    create table(:sys_accounts_pictures, primary_key: false) do
    ...
    create index(:sys_accounts_pictures, [:remote_id], unique: true)
  end
end
