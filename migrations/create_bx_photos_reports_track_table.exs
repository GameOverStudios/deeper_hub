defmodule Repo.Migrations.CreateBxPhotosReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_photos_reports_track, primary_key: false) do
    ...
    create index(:bx_photos_reports_track, [:object_id])
  end
end
