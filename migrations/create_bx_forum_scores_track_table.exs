defmodule Repo.Migrations.CreateBxForumScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_forum_scores_track, primary_key: false) do
    ...
    create index(:bx_forum_scores_track, [:object_id])
  end
end
