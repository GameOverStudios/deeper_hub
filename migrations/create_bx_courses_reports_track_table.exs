defmodule Repo.Migrations.CreateBxCoursesReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_courses_reports_track, primary_key: false) do
    ...
    create index(:bx_courses_reports_track, [:object_id])
  end
end
