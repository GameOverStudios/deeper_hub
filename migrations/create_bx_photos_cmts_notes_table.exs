defmodule Repo.Migrations.CreateBxPhotosCmtsNotes do
  use Ecto.Migration

  def change do
    create table(:bx_photos_cmts_notes, primary_key: false) do
    ...
    create index(:bx_photos_cmts_notes, [:cmt_object_id])
    create index(:bx_photos_cmts_notes, [:cmt_text])
  end
end
