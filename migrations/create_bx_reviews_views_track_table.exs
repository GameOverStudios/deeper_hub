defmodule Repo.Migrations.CreateBxReviewsViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_views_track, primary_key: false) do
    ...
    create index(:bx_reviews_views_track, [:object_id])
  end
end
