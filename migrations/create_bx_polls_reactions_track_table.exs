defmodule Repo.Migrations.CreateBxPollsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_polls_reactions_track, primary_key: false) do
    ...
    create index(:bx_polls_reactions_track, [:object_id])
  end
end
