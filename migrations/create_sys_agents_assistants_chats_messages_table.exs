defmodule Repo.Migrations.CreateSysAgentsAssistantsChatsMessages do
  use Ecto.Migration

  def change do
    create table(:sys_agents_assistants_chats_messages, primary_key: false) do
    ...
    create index(:sys_agents_assistants_chats_messages, [:cmt_object_id])
    create index(:sys_agents_assistants_chats_messages, [:cmt_text])
  end
end
