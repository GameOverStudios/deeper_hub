defmodule Repo.Migrations.CreateBxGlossaryFiles do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_files, primary_key: false) do
    ...
    create index(:bx_glossary_files, [:remote_id], unique: true)
  end
end
