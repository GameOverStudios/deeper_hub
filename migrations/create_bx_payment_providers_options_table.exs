defmodule Repo.Migrations.CreateBxPaymentProvidersOptions do
  use Ecto.Migration

  def change do
    create table(:bx_payment_providers_options, primary_key: false) do
      add :id, :binary_id, primary_key: true
      add :provider_id, :string, null: false, default: ""
    ...
    create index(:bx_payment_providers_options, [:name], unique: true)
  end
end
