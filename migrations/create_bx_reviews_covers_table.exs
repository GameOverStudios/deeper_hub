defmodule Repo.Migrations.CreateBxReviewsCovers do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_covers, primary_key: false) do
    ...
    create index(:bx_reviews_covers, [:remote_id], unique: true)
  end
end
