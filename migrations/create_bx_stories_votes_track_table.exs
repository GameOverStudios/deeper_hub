defmodule Repo.Migrations.CreateBxStoriesVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_stories_votes_track, primary_key: false) do
    ...
    create index(:bx_stories_votes_track, [:object_id])
  end
end
