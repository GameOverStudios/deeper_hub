defmodule Repo.Migrations.CreateBxCnlCmtsNotes do
  use Ecto.Migration

  def change do
    create table(:bx_cnl_cmts_notes, primary_key: false) do
    ...
    create index(:bx_cnl_cmts_notes, [:cmt_object_id])
    create index(:bx_cnl_cmts_notes, [:cmt_text])
  end
end
