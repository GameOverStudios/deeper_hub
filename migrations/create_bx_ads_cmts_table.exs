defmodule Repo.Migrations.CreateBxAdsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_ads_cmts, primary_key: false) do
    ...
    create index(:bx_ads_cmts, [:cmt_object_id])
    create index(:bx_ads_cmts, [:cmt_text])
  end
end
