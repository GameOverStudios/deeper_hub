defmodule Repo.Migrations.CreateBxAlbumsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_albums_reports_track, primary_key: false) do
    ...
    create index(:bx_albums_reports_track, [:object_id])
  end
end
