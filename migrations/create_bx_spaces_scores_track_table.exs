defmodule Repo.Migrations.CreateBxSpacesScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_scores_track, primary_key: false) do
    ...
    create index(:bx_spaces_scores_track, [:object_id])
  end
end
