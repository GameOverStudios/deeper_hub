defmodule Repo.Migrations.CreateBxTasksReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_tasks_reactions_track, primary_key: false) do
    ...
    create index(:bx_tasks_reactions_track, [:object_id])
  end
end
