defmodule Repo.Migrations.CreateSysCmtsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:sys_cmts_reactions_track, primary_key: false) do
    ...
    create index(:sys_cmts_reactions_track, [:object_id])
  end
end
