defmodule Repo.Migrations.CreateBxForumReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_forum_reports_track, primary_key: false) do
    ...
    create index(:bx_forum_reports_track, [:object_id])
  end
end
