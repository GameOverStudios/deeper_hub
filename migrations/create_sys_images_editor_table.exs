defmodule Repo.Migrations.CreateSysImagesEditor do
  use Ecto.Migration

  def change do
    create table(:sys_images_editor, primary_key: false) do
    ...
    create index(:sys_images_editor, [:remote_id], unique: true)
  end
end
