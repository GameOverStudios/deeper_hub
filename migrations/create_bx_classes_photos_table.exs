defmodule Repo.Migrations.CreateBxClassesPhotos do
  use Ecto.Migration

  def change do
    create table(:bx_classes_photos, primary_key: false) do
    ...
    create index(:bx_classes_photos, [:remote_id], unique: true)
  end
end
