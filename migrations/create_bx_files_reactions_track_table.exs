defmodule Repo.Migrations.CreateBxFilesReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_files_reactions_track, primary_key: false) do
    ...
    create index(:bx_files_reactions_track, [:object_id])
  end
end
