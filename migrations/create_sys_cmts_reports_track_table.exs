defmodule Repo.Migrations.CreateSysCmtsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:sys_cmts_reports_track, primary_key: false) do
    ...
    create index(:sys_cmts_reports_track, [:object_id])
  end
end
