defmodule Repo.Migrations.CreateBxPersonsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_persons_scores_track, primary_key: false) do
    ...
    create index(:bx_persons_scores_track, [:object_id])
  end
end
