defmodule Repo.Migrations.CreateBxGroupsViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_groups_views_track, primary_key: false) do
    ...
    create index(:bx_groups_views_track, [:object_id])
  end
end
