defmodule Repo.Migrations.CreateBxCoursesPicsResized do
  use Ecto.Migration

  def change do
    create table(:bx_courses_pics_resized, primary_key: false) do
    ...
    create index(:bx_courses_pics_resized, [:remote_id], unique: true)
  end
end
