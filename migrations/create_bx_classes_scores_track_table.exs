defmodule Repo.Migrations.CreateBxClassesScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_classes_scores_track, primary_key: false) do
    ...
    create index(:bx_classes_scores_track, [:object_id])
  end
end
