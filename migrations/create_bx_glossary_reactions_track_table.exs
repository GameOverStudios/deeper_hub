defmodule Repo.Migrations.CreateBxGlossaryReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_reactions_track, primary_key: false) do
    ...
    create index(:bx_glossary_reactions_track, [:object_id])
  end
end
