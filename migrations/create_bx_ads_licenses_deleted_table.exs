defmodule Repo.Migrations.CreateBxAdsLicensesDeleted do
  use Ecto.Migration

  def change do
    create table(:bx_ads_licenses_deleted, primary_key: false) do
    ...
    create index(:bx_ads_licenses_deleted, [:entry_id])
    create index(:bx_ads_licenses_deleted, [:license])
  end
end
