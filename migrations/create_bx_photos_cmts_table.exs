defmodule Repo.Migrations.CreateBxPhotosCmts do
  use Ecto.Migration

  def change do
    create table(:bx_photos_cmts, primary_key: false) do
    ...
    create index(:bx_photos_cmts, [:cmt_object_id])
    create index(:bx_photos_cmts, [:cmt_text])
  end
end
