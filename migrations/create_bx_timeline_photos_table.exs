defmodule Repo.Migrations.CreateBxTimelinePhotos do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_photos, primary_key: false) do
    ...
    create index(:bx_timeline_photos, [:remote_id], unique: true)
  end
end
