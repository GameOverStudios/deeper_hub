defmodule Repo.Migrations.CreateBxOrganizationsVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_votes_track, primary_key: false) do
    ...
    create index(:bx_organizations_votes_track, [:object_id])
  end
end
