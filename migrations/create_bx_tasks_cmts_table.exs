defmodule Repo.Migrations.CreateBxTasksCmts do
  use Ecto.Migration

  def change do
    create table(:bx_tasks_cmts, primary_key: false) do
    ...
    create index(:bx_tasks_cmts, [:cmt_object_id])
    create index(:bx_tasks_cmts, [:cmt_text])
  end
end
