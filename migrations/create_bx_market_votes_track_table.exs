defmodule Repo.Migrations.CreateBxMarketVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_market_votes_track, primary_key: false) do
    ...
    create index(:bx_market_votes_track, [:object_id])
  end
end
