defmodule Repo.Migrations.CreateBxReviewsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_reactions_track, primary_key: false) do
    ...
    create index(:bx_reviews_reactions_track, [:object_id])
  end
end
