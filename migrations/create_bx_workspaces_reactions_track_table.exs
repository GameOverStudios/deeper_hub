defmodule Repo.Migrations.CreateBxWorkspacesReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_workspaces_reactions_track, primary_key: false) do
    ...
    create index(:bx_workspaces_reactions_track, [:object_id])
  end
end
