defmodule Repo.Migrations.CreateBxPersonsVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_persons_votes_track, primary_key: false) do
    ...
    create index(:bx_persons_votes_track, [:object_id])
  end
end
