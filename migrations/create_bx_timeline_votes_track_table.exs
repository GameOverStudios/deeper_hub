defmodule Repo.Migrations.CreateBxTimelineVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_votes_track, primary_key: false) do
    ...
    create index(:bx_timeline_votes_track, [:object_id])
  end
end
