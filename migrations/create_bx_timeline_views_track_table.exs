defmodule Repo.Migrations.CreateBxTimelineViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_views_track, primary_key: false) do
    ...
    create index(:bx_timeline_views_track, [:object_id])
  end
end
