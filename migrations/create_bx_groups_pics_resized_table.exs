defmodule Repo.Migrations.CreateBxGroupsPicsResized do
  use Ecto.Migration

  def change do
    create table(:bx_groups_pics_resized, primary_key: false) do
    ...
    create index(:bx_groups_pics_resized, [:remote_id], unique: true)
  end
end
