defmodule Repo.Migrations.CreateBxJobsPrices do
  use Ecto.Migration

  def change do
    create table(:bx_jobs_prices, primary_key: false) do
    ...
    create index(:bx_jobs_prices, [:profile_id])
    create index(:bx_jobs_prices, [:name], unique: true)
  end
end
