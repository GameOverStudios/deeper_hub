defmodule Repo.Migrations.CreateBxJobsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_jobs_reactions_track, primary_key: false) do
    ...
    create index(:bx_jobs_reactions_track, [:object_id])
  end
end
