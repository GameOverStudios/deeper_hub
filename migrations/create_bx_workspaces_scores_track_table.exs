defmodule Repo.Migrations.CreateBxWorkspacesScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_workspaces_scores_track, primary_key: false) do
    ...
    create index(:bx_workspaces_scores_track, [:object_id])
  end
end
