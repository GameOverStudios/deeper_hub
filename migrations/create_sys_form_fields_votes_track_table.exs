defmodule Repo.Migrations.CreateSysFormFieldsVotesTrack do
  use Ecto.Migration

  def change do
    create table(:sys_form_fields_votes_track, primary_key: false) do
    ...
    create index(:sys_form_fields_votes_track, [:object_id])
  end
end
