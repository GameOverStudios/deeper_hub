defmodule Repo.Migrations.CreateBxClassesFiles do
  use Ecto.Migration

  def change do
    create table(:bx_classes_files, primary_key: false) do
    ...
    create index(:bx_classes_files, [:remote_id], unique: true)
  end
end
