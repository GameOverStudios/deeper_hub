defmodule Repo.Migrations.CreateBxAlbumsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_albums_reactions_track, primary_key: false) do
    ...
    create index(:bx_albums_reactions_track, [:object_id])
  end
end
