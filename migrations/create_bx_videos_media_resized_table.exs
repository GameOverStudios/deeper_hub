defmodule Repo.Migrations.CreateBxVideosMediaResized do
  use Ecto.Migration

  def change do
    create table(:bx_videos_media_resized, primary_key: false) do
    ...
    create index(:bx_videos_media_resized, [:remote_id], unique: true)
  end
end
