defmodule Repo.Migrations.CreateBxOrganizationsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_organizations_reports_track, primary_key: false) do
    ...
    create index(:bx_organizations_reports_track, [:object_id])
  end
end
