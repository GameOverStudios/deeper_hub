defmodule Repo.Migrations.CreateSysCmtsImagesPreview do
  use Ecto.Migration

  def change do
    create table(:sys_cmts_images_preview, primary_key: false) do
    ...
    create index(:sys_cmts_images_preview, [:remote_id], unique: true)
  end
end
