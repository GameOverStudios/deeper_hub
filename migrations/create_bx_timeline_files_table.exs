defmodule Repo.Migrations.CreateBxTimelineFiles do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_files, primary_key: false) do
    ...
    create index(:bx_timeline_files, [:remote_id], unique: true)
  end
end
