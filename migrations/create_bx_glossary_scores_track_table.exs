defmodule Repo.Migrations.CreateBxGlossaryScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_scores_track, primary_key: false) do
    ...
    create index(:bx_glossary_scores_track, [:object_id])
  end
end
