defmodule Repo.Migrations.CreateBxPhotosViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_photos_views_track, primary_key: false) do
    ...
    create index(:bx_photos_views_track, [:object_id])
  end
end
