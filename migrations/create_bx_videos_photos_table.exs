defmodule Repo.Migrations.CreateBxVideosPhotos do
  use Ecto.Migration

  def change do
    create table(:bx_videos_photos, primary_key: false) do
    ...
    create index(:bx_videos_photos, [:remote_id], unique: true)
  end
end
