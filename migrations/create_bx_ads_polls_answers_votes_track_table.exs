defmodule Repo.Migrations.CreateBxAdsPollsAnswersVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_ads_polls_answers_votes_track, primary_key: false) do
    ...
    create index(:bx_ads_polls_answers_votes_track, [:object_id])
  end
end
