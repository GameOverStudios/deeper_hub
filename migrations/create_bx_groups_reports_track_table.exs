defmodule Repo.Migrations.CreateBxGroupsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_groups_reports_track, primary_key: false) do
    ...
    create index(:bx_groups_reports_track, [:object_id])
  end
end
