defmodule Repo.Migrations.CreateBxCoursesViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_courses_views_track, primary_key: false) do
    ...
    create index(:bx_courses_views_track, [:object_id])
  end
end
