defmodule Repo.Migrations.CreateBxSpacesPicsResized do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_pics_resized, primary_key: false) do
    ...
    create index(:bx_spaces_pics_resized, [:remote_id], unique: true)
  end
end
