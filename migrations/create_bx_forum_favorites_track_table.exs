defmodule Repo.Migrations.CreateBxForumFavoritesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_forum_favorites_track, primary_key: false) do
    ...
    create index(:bx_forum_favorites_track, [:object_id])
  end
end
