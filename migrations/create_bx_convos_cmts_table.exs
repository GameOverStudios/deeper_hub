defmodule Repo.Migrations.CreateBxConvosCmts do
  use Ecto.Migration

  def change do
    create table(:bx_convos_cmts, primary_key: false) do
    ...
    create index(:bx_convos_cmts, [:cmt_object_id])
    create index(:bx_convos_cmts, [:cmt_text])
  end
end
