defmodule Repo.Migrations.CreateBxMarketPhotos do
  use Ecto.Migration

  def change do
    create table(:bx_market_photos, primary_key: false) do
    ...
    create index(:bx_market_photos, [:remote_id], unique: true)
  end
end
