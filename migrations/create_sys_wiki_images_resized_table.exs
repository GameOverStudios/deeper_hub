defmodule Repo.Migrations.CreateSysWikiImagesResized do
  use Ecto.Migration

  def change do
    create table(:sys_wiki_images_resized, primary_key: false) do
    ...
    create index(:sys_wiki_images_resized, [:remote_id], unique: true)
  end
end
