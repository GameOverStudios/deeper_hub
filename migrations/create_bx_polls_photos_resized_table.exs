defmodule Repo.Migrations.CreateBxPollsPhotosResized do
  use Ecto.Migration

  def change do
    create table(:bx_polls_photos_resized, primary_key: false) do
    ...
    create index(:bx_polls_photos_resized, [:remote_id], unique: true)
  end
end
