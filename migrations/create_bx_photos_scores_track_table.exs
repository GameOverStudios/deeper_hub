defmodule Repo.Migrations.CreateBxPhotosScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_photos_scores_track, primary_key: false) do
    ...
    create index(:bx_photos_scores_track, [:object_id])
  end
end
