defmodule Repo.Migrations.CreateBxGroupsVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_groups_votes_track, primary_key: false) do
    ...
    create index(:bx_groups_votes_track, [:object_id])
  end
end
