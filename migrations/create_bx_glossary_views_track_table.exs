defmodule Repo.Migrations.CreateBxGlossaryViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_views_track, primary_key: false) do
    ...
    create index(:bx_glossary_views_track, [:object_id])
  end
end
