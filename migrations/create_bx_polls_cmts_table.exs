defmodule Repo.Migrations.CreateBxPollsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_polls_cmts, primary_key: false) do
    ...
    create index(:bx_polls_cmts, [:cmt_object_id])
    create index(:bx_polls_cmts, [:cmt_text])
  end
end
