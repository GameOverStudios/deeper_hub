defmodule Repo.Migrations.CreateBxPhotosSvotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_photos_svotes_track, primary_key: false) do
    ...
    create index(:bx_photos_svotes_track, [:object_id])
  end
end
