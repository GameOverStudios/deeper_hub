defmodule Repo.Migrations.CreateBxSpacesStarsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_stars_track, primary_key: false) do
    ...
    create index(:bx_spaces_stars_track, [:object_id])
  end
end
