defmodule Repo.Migrations.CreateBxCoursesPrices do
  use Ecto.Migration

  def change do
    create table(:bx_courses_prices, primary_key: false) do
    ...
    create index(:bx_courses_prices, [:profile_id])
    create index(:bx_courses_prices, [:name], unique: true)
  end
end
