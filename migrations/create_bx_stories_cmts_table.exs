defmodule Repo.Migrations.CreateBxStoriesCmts do
  use Ecto.Migration

  def change do
    create table(:bx_stories_cmts, primary_key: false) do
    ...
    create index(:bx_stories_cmts, [:cmt_object_id])
    create index(:bx_stories_cmts, [:cmt_text])
  end
end
