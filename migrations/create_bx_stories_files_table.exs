defmodule Repo.Migrations.CreateBxStoriesFiles do
  use Ecto.Migration

  def change do
    create table(:bx_stories_files, primary_key: false) do
    ...
    create index(:bx_stories_files, [:remote_id], unique: true)
  end
end
