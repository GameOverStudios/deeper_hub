defmodule Repo.Migrations.CreateBxStoriesReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_stories_reports_track, primary_key: false) do
    ...
    create index(:bx_stories_reports_track, [:object_id])
  end
end
