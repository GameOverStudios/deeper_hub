defmodule Repo.Migrations.CreateBxEventsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_events_scores_track, primary_key: false) do
    ...
    create index(:bx_events_scores_track, [:object_id])
  end
end
