defmodule Repo.Migrations.CreateBxAlbumsPhotosResized do
  use Ecto.Migration

  def change do
    create table(:bx_albums_photos_resized, primary_key: false) do
    ...
    create index(:bx_albums_photos_resized, [:remote_id], unique: true)
  end
end
