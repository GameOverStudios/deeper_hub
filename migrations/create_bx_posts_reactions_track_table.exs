defmodule Repo.Migrations.CreateBxPostsReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_posts_reactions_track, primary_key: false) do
    ...
    create index(:bx_posts_reactions_track, [:object_id])
  end
end
