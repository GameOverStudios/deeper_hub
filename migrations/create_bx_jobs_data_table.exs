defmodule Repo.Migrations.CreateBxJobsData do
  use Ecto.Migration

  def change do
    create table(:bx_jobs_data, primary_key: false) do
      ...
      add :timezone, :string
      add :pay_hourly, :float, null: false, default: 0
      add :pay_total, :float, null: false, default: 0
    ...
    create index(:bx_jobs_data, [:name])
  end
end
