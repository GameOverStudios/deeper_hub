defmodule Repo.Migrations.CreateBxFilesSoundsResized do
  use Ecto.Migration

  def change do
    create table(:bx_files_sounds_resized, primary_key: false) do
    ...
    create index(:bx_files_sounds_resized, [:remote_id], unique: true)
  end
end
