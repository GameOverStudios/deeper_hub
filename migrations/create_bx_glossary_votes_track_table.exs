defmodule Repo.Migrations.CreateBxGlossaryVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_glossary_votes_track, primary_key: false) do
    ...
    create index(:bx_glossary_votes_track, [:object_id])
  end
end
