defmodule Repo.Migrations.CreateBxTimelineCmtsNotes do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_cmts_notes, primary_key: false) do
    ...
    create index(:bx_timeline_cmts_notes, [:cmt_object_id])
    create index(:bx_timeline_cmts_notes, [:cmt_text])
  end
end
