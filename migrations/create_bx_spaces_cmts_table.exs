defmodule Repo.Migrations.CreateBxSpacesCmts do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_cmts, primary_key: false) do
    ...
    create index(:bx_spaces_cmts, [:cmt_object_id])
    create index(:bx_spaces_cmts, [:cmt_text])
  end
end
