defmodule Repo.Migrations.CreateBxAdsReviews do
  use Ecto.Migration

  def change do
    create table(:bx_ads_reviews, primary_key: false) do
    ...
    create index(:bx_ads_reviews, [:cmt_object_id])
    create index(:bx_ads_reviews, [:cmt_text])
  end
end
