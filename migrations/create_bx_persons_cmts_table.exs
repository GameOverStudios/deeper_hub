defmodule Repo.Migrations.CreateBxPersonsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_persons_cmts, primary_key: false) do
    ...
    create index(:bx_persons_cmts, [:cmt_object_id])
    create index(:bx_persons_cmts, [:cmt_text])
  end
end
