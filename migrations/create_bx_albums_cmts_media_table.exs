defmodule Repo.Migrations.CreateBxAlbumsCmtsMedia do
  use Ecto.Migration

  def change do
    create table(:bx_albums_cmts_media, primary_key: false) do
    ...
    create index(:bx_albums_cmts_media, [:cmt_object_id])
    create index(:bx_albums_cmts_media, [:cmt_text])
  end
end
