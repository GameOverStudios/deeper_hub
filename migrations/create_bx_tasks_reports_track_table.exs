defmodule Repo.Migrations.CreateBxTasksReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_tasks_reports_track, primary_key: false) do
    ...
    create index(:bx_tasks_reports_track, [:object_id])
  end
end
