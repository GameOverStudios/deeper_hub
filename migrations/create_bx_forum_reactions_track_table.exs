defmodule Repo.Migrations.CreateBxForumReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_forum_reactions_track, primary_key: false) do
    ...
    create index(:bx_forum_reactions_track, [:object_id])
  end
end
