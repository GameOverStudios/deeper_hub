defmodule Repo.Migrations.CreateBxSpacesVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_spaces_votes_track, primary_key: false) do
    ...
    create index(:bx_spaces_votes_track, [:object_id])
  end
end
