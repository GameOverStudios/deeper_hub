defmodule Repo.Migrations.CreateBxCnlPicsResized do
  use Ecto.Migration

  def change do
    create table(:bx_cnl_pics_resized, primary_key: false) do
    ...
    create index(:bx_cnl_pics_resized, [:remote_id], unique: true)
  end
end
