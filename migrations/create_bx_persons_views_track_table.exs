defmodule Repo.Migrations.CreateBxPersonsViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_persons_views_track, primary_key: false) do
    ...
    create index(:bx_persons_views_track, [:object_id])
  end
end
