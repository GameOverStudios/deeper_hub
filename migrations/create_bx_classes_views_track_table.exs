defmodule Repo.Migrations.CreateBxClassesViewsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_classes_views_track, primary_key: false) do
    ...
    create index(:bx_classes_views_track, [:object_id])
  end
end
