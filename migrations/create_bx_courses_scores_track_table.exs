defmodule Repo.Migrations.CreateBxCoursesScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_courses_scores_track, primary_key: false) do
    ...
    create index(:bx_courses_scores_track, [:object_id])
  end
end
