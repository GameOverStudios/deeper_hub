defmodule Repo.Migrations.CreateBxGroupsCmts do
  use Ecto.Migration

  def change do
    create table(:bx_groups_cmts, primary_key: false) do
    ...
    create index(:bx_groups_cmts, [:cmt_object_id])
    create index(:bx_groups_cmts, [:cmt_text])
  end
end
