defmodule Repo.Migrations.CreateBxAlbumsScoresMediaTrack do
  use Ecto.Migration

  def change do
    create table(:bx_albums_scores_media_track, primary_key: false) do
    ...
    create index(:bx_albums_scores_media_track, [:object_id])
  end
end
