defmodule Repo.Migrations.CreateBxClassesVideosResized do
  use Ecto.Migration

  def change do
    create table(:bx_classes_videos_resized, primary_key: false) do
    ...
    create index(:bx_classes_videos_resized, [:remote_id], unique: true)
  end
end
