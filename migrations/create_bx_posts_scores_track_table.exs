defmodule Repo.Migrations.CreateBxPostsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_posts_scores_track, primary_key: false) do
    ...
    create index(:bx_posts_scores_track, [:object_id])
  end
end
