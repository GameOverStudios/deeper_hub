defmodule Repo.Migrations.CreateBxVideosVideos do
  use Ecto.Migration

  def change do
    create table(:bx_videos_videos, primary_key: false) do
    ...
    create index(:bx_videos_videos, [:remote_id], unique: true)
  end
end
