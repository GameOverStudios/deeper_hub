defmodule Repo.Migrations.CreateBxReviewsPhotosResized do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_photos_resized, primary_key: false) do
    ...
    create index(:bx_reviews_photos_resized, [:remote_id], unique: true)
  end
end
