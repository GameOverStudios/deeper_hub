defmodule Repo.Migrations.CreateBxEventsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_events_reports_track, primary_key: false) do
    ...
    create index(:bx_events_reports_track, [:object_id])
  end
end
