defmodule Repo.Migrations.CreateBxEventsVotesTrack do
  use Ecto.Migration

  def change do
    create table(:bx_events_votes_track, primary_key: false) do
    ...
    create index(:bx_events_votes_track, [:object_id])
  end
end
