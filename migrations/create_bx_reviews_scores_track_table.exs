defmodule Repo.Migrations.CreateBxReviewsScoresTrack do
  use Ecto.Migration

  def change do
    create table(:bx_reviews_scores_track, primary_key: false) do
    ...
    create index(:bx_reviews_scores_track, [:object_id])
  end
end
