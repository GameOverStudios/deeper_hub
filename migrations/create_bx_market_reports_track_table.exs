defmodule Repo.Migrations.CreateBxMarketReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_market_reports_track, primary_key: false) do
    ...
    create index(:bx_market_reports_track, [:object_id])
  end
end
