defmodule Repo.Migrations.CreateBxTimelineReactionsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_reactions_track, primary_key: false) do
    ...
    create index(:bx_timeline_reactions_track, [:object_id])
  end
end
