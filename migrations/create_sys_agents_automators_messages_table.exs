defmodule Repo.Migrations.CreateSysAgentsAutomatorsMessages do
  use Ecto.Migration

  def change do
    create table(:sys_agents_automators_messages, primary_key: false) do
    ...
    create index(:sys_agents_automators_messages, [:cmt_object_id])
    create index(:sys_agents_automators_messages, [:cmt_text])
  end
end
