defmodule Repo.Migrations.CreateBxPersonsReportsTrack do
  use Ecto.Migration

  def change do
    create table(:bx_persons_reports_track, primary_key: false) do
    ...
    create index(:bx_persons_reports_track, [:object_id])
  end
end
