defmodule Repo.Migrations.CreateBxTimelineEventsSlice do
  use Ecto.Migration

  def change do
    create table(:bx_timeline_events_slice, primary_key: false) do
    ...
    create index(:bx_timeline_events_slice, [:owner_id])
    create index(:bx_timeline_events_slice, [:object_id])
    create index(:bx_timeline_events_slice, [:title])
  end
end
