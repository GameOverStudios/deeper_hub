# Migração gerada com ID único: V1748745503886 em 2025-05-31 23:38:23
defmodule DeeperHub.Core.Data.Migrations.CreateDeeperArticlesTable do
  # Migração gerada com ID único: V1748745503886 em 2025-05-31 23:38:23
  @moduledoc """
  ...
  def up do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao criar tabela deeper_articles: #{inspect(reason)}",
          module: __MODULE__
        )
  ...
  def down do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao remover tabela deeper_articles: #{inspect(reason)}",
          module: __MODULE__
        )
