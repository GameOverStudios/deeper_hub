...
defmodule DeeperHub.Core.Data.Migrations.CreateSysOptionsMixes2OptionsTable do
  ...
  def up do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao criar tabela sys_options_mixes2options: #{inspect(reason)}",
          module: __MODULE__
        )
  ...
  def down do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao remover tabela sys_options_mixes2options: #{inspect(reason)}",
          module: __MODULE__
        )
