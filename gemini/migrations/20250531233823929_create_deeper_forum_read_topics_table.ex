...
defmodule DeeperHub.Core.Data.Migrations.CreateDeeperForumReadTopicsTable do
  ...
  def up do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao criar tabela deeper_forum_read_topics: #{inspect(reason)}",
          module: __MODULE__
        )
  ...
  def down do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao remover tabela deeper_forum_read_topics: #{inspect(reason)}",
          module: __MODULE__
        )
