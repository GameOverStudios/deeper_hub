# Migração gerada com ID único: V1748745503960 em 2025-05-31 23:38:23
defmodule DeeperHub.Core.Data.Migrations.CreateDeeperPollsTable do
  # Migração gerada com ID único: V1748745503960 em 2025-05-31 23:38:23
  @moduledoc """
  ...
  def down do
    ...
    case Repo.execute(sql) do
      ...
      {:error, reason} ->
        Logger.error("Falha ao remover tabela deeper_polls: #{inspect(reason)}",
          module: __MODULE__
        )
