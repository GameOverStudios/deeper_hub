defmodule DeeperHub.Core.Data.Schemas.{{MODULE_NAME}} do
  ...
  def all do
    Logger.info("Buscando todos os registros de {{TABLE_NAME}}...", module: __MODULE__)
  ...
  def create(attrs) do
    Logger.info("Criando novo registro de {{SINGULAR_NAME}}: #{attrs}", module: __MODULE__)
  ...
  def get_by(field, value) do
    Logger.info("Buscando {{SINGULAR_NAME}}s por #{field}: #{value}", module: __MODULE__)
