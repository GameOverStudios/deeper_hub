...
# Executa os testes
try do
  {user_id, user} = Deeper_Hub.Core.Data.Testes.teste_usuarios()
  Logger.info("Teste de usuários concluído com sucesso! ID: #{user_id}")

  Deeper_Hub.Core.Data.Testes.teste_perfis(user_id)
  Logger.info("Teste de perfis concluído com sucesso!")

  Deeper_Hub.Core.Data.Testes.teste_joins(user_id)
